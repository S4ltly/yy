...
public class GysfkdysjsywkToSAPActionV10 extends BaseBean implements Action {

    private Logger logger = LoggerFactory.getLogger(GysfkdysjsywkToSAPActionV10.class);
        ...
        if (rs.next()){
            ...
            pjqysdykhbm = Util.null2String(rs.getString("pjqysdykhbm"));
             ...
             if ("3".equals(fklx)) {
                 ...
                 //采购订单
                 String EBELN = "";
                 String detailSql = "select * from " + tableName + "_dt5 where mainid = ? ";
...
//                     //流程单据序号
                     ...
                     //采购订单
                     EBELN = Util.null2String(rs.getString("ddbh"));
