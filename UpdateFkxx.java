...
public class UpdateFkxx {


    private Logger logger = LoggerFactory.getLogger(UpdateFkxx.class);

    public static void main(String[] args) {
        UpdateFkxx updateFkxx = new UpdateFkxx();
        updateFkxx.doAction(null);
    }
    ...
    public String doAction(JSONArray jsonArray){
        ...
        operationinfo.put("operator", "1");
            ...
            maintable.put("oaqqid", "450854");
            maintable.put("oamxid", "1");
            maintable.put("sapbh", "1");
            maintable.put("je", 1000000.00);
            maintable.put("fs", 1);
        ...
        logger.info("===请求参数datajson===" + JSON.toJSONString(paramsList));
        mainparams.put("data", paramsList);

        params.put("datajson", mainparams);
        System.out.println(JSON.toJSONString(params));
        String result = HttpRequest.post("http://172.16.0.20:8081/api/cube/restful/interface/saveOrUpdateModeData/SAPFKXX")
...
//                nvps.add(new BasicNameValuePair((String) key, JSON.toJSONString(value)));
//            });
//
//        }
//
