...
public class GysfkwzqfkToSAPActionV15 extends BaseBean implements Action {

    private Logger logger = LoggerFactory.getLogger(GysfkwzqfkToSAPActionV15.class);
    ...
    public String execute(RequestInfo requestInfo) {
        ...
        logger.info("GysfkwzqfkToSAPAction++++++++++++++++" + currentMonth);
        String msg = "";
        ...
        logger.info("进入接口---GysfkwzqfkToSAPAction,requestId:" + requestId + "," + "表单名称：" + tableName + ",workflowid=" + workflowid);
        //主表
        //流程类型
        String ZLCLX = "GYSFK3";
        //流程主题
        ...
        if (rs.next()) {
            ...
            //票据前一手对应编码
            KUNNR = Util.null2String(rs.getString("pjqysdykhbm"));
            //承兑编号
            ZBLNO = Util.null2String(rs.getString("pjdh"));
            //流程单据号
            ZDJH_OA =Util.null2String(rs.getString("lcbh"));
            //对应承兑类型
        ...
        if ("0".equals(fklx)) {
            ...
            String EBELN = "";
                ...
                while (rs.next()) {
                    //采购订单
                    EBELN = Util.null2String(rs.getString("cgddh2"));
...
//                     //流程单据序号
                    ...
                    //不含税金额
                    ZNET2=Util.null2String(rs.getString("bcfkjeyb"));
